...
namespace kb_mod {
    constexpr flag_t<detail::tag_kb_modifiers, 0>    left_shift  {};
    constexpr flag_t<detail::tag_kb_modifiers, 1>    right_shift {};
    constexpr flag_t<detail::tag_kb_modifiers, 0, 1> shift       {};

    constexpr flag_t<detail::tag_kb_modifiers, 6>    left_ctrl  {};
    constexpr flag_t<detail::tag_kb_modifiers, 7>    right_ctrl {};
    constexpr flag_t<detail::tag_kb_modifiers, 6, 7> ctrl       {};

    constexpr flag_t<detail::tag_kb_modifiers, 8>    left_alt  {};
    constexpr flag_t<detail::tag_kb_modifiers, 9>    right_alt {};
    constexpr flag_t<detail::tag_kb_modifiers, 8, 9> alt       {};

    constexpr flag_t<detail::tag_kb_modifiers, 10>     left_gui  {};
    constexpr flag_t<detail::tag_kb_modifiers, 11>     right_gui {};
    constexpr flag_t<detail::tag_kb_modifiers, 10, 11> gui       {};

    constexpr flag_t<detail::tag_kb_modifiers, 12> num  {};
    constexpr flag_t<detail::tag_kb_modifiers, 13> caps {};
    constexpr flag_t<detail::tag_kb_modifiers, 14> mod  {};
} // namespace kmod
